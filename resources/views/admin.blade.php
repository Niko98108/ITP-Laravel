...
<body>
 ...
 <div class="container">
  <div class="jumbotron">
      ...
      <a href="/createpdf" class="btn btn-outline-primary btn-lg" > PDF
        <svg width="1em" height="1em" viewBox="0 0 20 20" class="bi bi-file-earmark" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            <path d="M4 0h5.5v1H4a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V4.5h1V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2z"/>
            <path d="M9.5 3V0L14 4.5h-3A1.5 1.5 0 0 1 9.5 3z"/>
          </svg>
    </a>
      </div>
    <h4 class="display-4">Admin - Food Items </h4>
  <table class="table">
